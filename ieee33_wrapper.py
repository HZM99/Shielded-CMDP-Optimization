...
@env_register
class IEEE33Wrapper(CMDP):
    """Wrapper that adapts the IEEE33BusEnv to use normalized action space compatible with OmniSafe."""

    # Must define supported environments
    # Support both the canonical ID and an alias often used in configs
    _support_envs = ['IEEE33-v0', 'OmniIEEE33-v0']
